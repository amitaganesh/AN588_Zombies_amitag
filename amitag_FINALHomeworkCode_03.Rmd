---
title: "amitag_FINALHomeworkCode_03"
...
# the plots for height, weight, and age seem to come from normal distributions as the theoretical outcomes (the red line) overlaps quite closely with the balck points.I think the other dist.'s could be log-normal distrubutions and a binomial distrubution. 
library(dbplyr)
...
# My challenges: 
#1. I had trouble remembering the correct syntax for ggplot and layering elements properly.

#2. It was hard to decide which variables were worth plotting or comparing.

#3. I got confused about when to use the bootstrap method versus a normal approximation.

#4. Interpreting skewed distributions and their confidence intervals was tricky. And just interpreting the graphs in general was a bit hard. 

#5. Managing all the code chunks and keeping my results organized took extra time. I had a hard time following my work sometimes and would have to make sure I'm following the right procedures. 
